...
func (j *Journal) GetIncompleteSubmissions () error {
	// Sql query
	...
	for res.Next() {
		...
		// Update slice
		j.SubmissionsIncomplete = append(j.SubmissionsIncomplete, num)
